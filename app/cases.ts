...
export type Case = {
  ...
  tagline?: string;
  /** e.g. "Grupo Plaenge" or "Confidential — Global Automotive OEM". */
  client?: string;
...
export const CASES: Case[] = [
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    duration: "Oct 2020 → Jan 2022 (15 months)",
    timeline: "15 months",
    ...
    sections: [
      ...
      {
        heading: "Discovery & Strategy — business",
        paragraphs: [
      ...
      {
        heading: "Discovery & Research — users",
        subsections: [
          {
            ...
            bullets: [
              "Quantitative — Microsoft Forms survey: 26 responses.",
  ...
  /* ---------------------------------------------------------------- */
  /*  CASE 02 — Smart Safety · Confidential automotive OEM             */
  /* ---------------------------------------------------------------- */
  {
    slug: "smart-safety",
    number: "02",
    ...
    year: "2022",
    title: "Smart Safety · Confidential Automotive OEM",
    client: "Confidential — Global Automotive Leader",
    tagline:
      "A proof of concept that turned mandatory safety equipment into a smart wearable — cutting waiting time for on-site engineers, keeping miners safe, and lifting on-site productivity.",
    disclaimer:
      "Client name anonymised at their request · POC assets not publicly shareable.",
    role: "Product Designer",
    industry: "Automotive · Mining",
    duration: "Apr 2022 → May 2022 (POC)",
    timeline: "6 weeks",
    tools: ["Figma"],
    ...
    goals: [
      ...
      "Ensure safety for all workers in hazardous underground and surface conditions.",
      "Increase miner productivity and performance without compromising safety.",
    ],
    sections: [
      {
        heading: "About the client",
        paragraphs: [
          "A global automotive leader with vehicles on the road in 100+ countries. 95+ years of heritage across iconic truck, bus, and construction-equipment divisions. Beyond passenger safety, they are a dominant force in the mining industry, delivering heavy-duty haulers and excavators designed for extreme efficiency.",
          "Known for pioneering sustainable engineering and uncompromising reliability, the client continues to set the standard for industrial innovation and environmental care.",
        ],
      },
      {
        heading: "Initial briefing",
        paragraphs: [
          "The proof of concept started with the client asking for a mobile solution to support machinery fixing for engineers, worker safety, and increased productivity for miners on-site.",
          "Personal safety equipment is required to safeguard miners in hazardous conditions — the sites include both underground and surface mines, and internet connectivity might be low or non-existent.",
        ],
      },
      {
        heading: "Discovery & Strategy — business",
        paragraphs: [
          "We started with a discovery to better understand the client's business model. In this phase, we learned about their existing partnerships with major AI and OS platforms, and how those partnerships were expected to shape day-to-day work across several industries.",
          "We also mapped their communication pillars — reliability, productivity at lower cost, and safety — and used them as the frame for every design decision.",
        ],
      },
      {
        heading: "Discovery & Research — users",
        paragraphs: [
          "Knowing where the business was heading, we kept the momentum with the requested mobile solution but reframed it. Rather than a phone app, we proposed a proof of concept for miners themselves: upgrade their mandatory personal safety equipment so it would serve both purposes — protection and repair support.",
        ],
      },
      {
        heading: "Define, wireframe & prototype",
        subsections: [
          ...
          },
          {
            ...
            paragraphs: [
              "Since the client's positioning centred on reliability, productivity at lower cost, and safety, we concluded a mobile app wouldn't be the fastest or safest option — miners would still need engineers on-site for anything complex, cutting into productivity.",
              "We pivoted to a Smart Safety concept: use the miner's existing personal safety equipment not only for safety, but for everything the mobile app would do. The first Smart Safety product would be a Safety Glass — high-contrast colours, clear voice command guidance, AI, machine learning, image recognition, sound analysis, augmented reality for step-by-step repair, and IoT.",
            ],
          },
          {
      ...
      },
      {
        ...
        paragraphs: [
          "Next steps for scaling the Smart Safety partnership: noise-cancelling earplugs for protection and voice guidance/calls, gloves with sensors connected to the glasses, textiles that sense environmental changes and share information with other Smart Safety devices, and expanded AR navigation possibilities.",
        ],
      },
    ],
    results: [
      ...
      "Client validated the direction and roadmap for continued exploration.",
    ],
  },
